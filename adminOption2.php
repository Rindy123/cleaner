...
<body>
	...
	<img src="logo1.png" alt="Organic Batch" width="120" height="120" style="width:145px">
		...
		<div class="col-md-6 register-form">
			<h2 class="registertext">  Cleaner Registration Form </h2>
			<form action="" method="post"> 
				...
				<div class="form-group">
					...
					<input type="text" placeholder="Enter Your Reference Number" name="refNo" class="form-control">
					</div>
	  ...
	  <h2 class="table2" style="text-align: center"  >CLEANER's Table</h2>
	<div class="insertupdatedelete">
		...
		if(isset($_POST["insert"])){
			...
			$sql= "DELETE FROM cleaners WHERE username = '$name'";
	...
	<div>			
				...
				if ($result){
					...
					$table = '<table>';
					$table .= "<tr><th>username</th><th>password</th><th>rePassword</th><th>fName</th><th>midInitial</th><th>lName</th><th>refNo</th><th>contact</th><th>email</th></tr>";
