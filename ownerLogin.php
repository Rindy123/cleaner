...
<body>
	...
	<div class="container">
		...
		<div class="col-md-6 login-left">
			...
			<h2 class="logintext"> Login For OWNER </h2>
			<form action="ownerValidation.php" method="post"> 
				...
				<a href="ownerRegisterForm.php"> <button type="submit"  class="regbtn"> Click here to Register </button> </a>
			</div>
        </div>
      </div>
    </div>
