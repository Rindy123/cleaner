...
<body>
	...
	<div class="container">
		...
		<div class="col-md-6 login-left">
			...
			<h2 class="logintext"> Login For Cleaner </h2>
			<form action="cleanerValidation.php" method="post"> 
			...
			<a href="cleanerRegisterForm.php"> <button type="submit"  class="regbtn"> Click here to Register </button> </a>
