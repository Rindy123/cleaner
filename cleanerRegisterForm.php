...
<body>
	...
	<img src="logo1.png" alt="Organic Batch" width="120" height="120" style="width:145px">
		...
		<div class="col-md-6 register-form">
			<h2 class="registertext">  Field Cleaner Registration Form </h2>
			<form action="cleanerRegistration.php" method="post"> 
				...
				<div class="form-group">
					...
					<input type="text" placeholder="Enter Your Reference Number" name="refNo" class="form-control" required>
					</div>
